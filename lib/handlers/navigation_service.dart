...
abstract class NavigationHandler {
  ...
  ///`lastRoute` is hit
  Future<dynamic>? pushNamedAndRemoveUntil(String destinationRoute, String lastRoute, {dynamic arg});
...
class NavigationHandlerImpl implements NavigationHandler {
  ...
  @override
  Future? pushNamedAndRemoveUntil(String destinationRoute, String lastRoute, {arg}) {
    if (state != null) {
